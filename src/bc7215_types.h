...
{
    uint16_t bitLen;    ///< Length of IR data in bits (0-65535)
...
typedef struct bc7215FormatPkt_t
{
     ...
     * - Inter-frame gaps
     * 
     * The specific meaning of each byte depends on the protocol signature.
     * Refer to BC7215 datasheet for detailed format specifications.
     */
